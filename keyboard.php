...
<html>
	<head>
		<title>Electro Built | KeyBoard</title>
		<meta charset="utf-8">
	...
	<body style="background-color:#1E1F24;">
		...
		<div class="container">
			<h1 class="m-5"><u style="color:white;">KeyBoard</u></h1>
			<form action="" method="POST">
				<div class="row">
					<!--------------------------------ROW 1----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="0">
						<div class="card btn" style="width: 18rem;height:609px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="1">
						<div class="card btn" style="width: 18rem;height:609px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="2">
						<div class="card btn" style="width: 18rem;height:609px;">
					...
					<!--------------------------------ROW 2----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="3">
						<div class="card btn" style="width: 18rem;height:560px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="4">
						<div class="card btn" style="width: 18rem;height:560px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="5">
						<div class="card btn" style="width: 18rem;height:560px;">
					...
					<!--------------------------------ROW 3----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="6">
						<div class="card btn" style="width: 18rem;height:576px;">
						  <img src="<?php echo $row[6]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><?php echo $row[6]['title'];?></h5>
							<p class="card-text"><br><br><?php echo $row[6]['description'];?>
							</p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="8">
						<div class="card btn" style="width: 18rem;height:576px;">
					...
					<!--------------------------------ROW 4----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="9">
						<div class="card btn" style="width: 18rem;height:641px;">
						  <img src="<?php echo $row[9]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><?php echo $row[9]['title'];?></h5>
							<p class="card-text"><?php echo $row[9]['description'];?>
							</p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="10">
						<div class="card btn" style="width: 18rem;height:641px;">
						  <img src="<?php echo $row[10]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><br><?php echo $row[10]['title'];?><br></h5>
							<p class="card-text"><br><br><?php echo $row[10]['description'];?>
							</p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button  name="kb" type="submit" value="11">
						<div class="card btn" style="width: 18rem;height:641px;">
