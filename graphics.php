...
<html>
	<head>
		<title>Electro Built | Graphics Card</title>
		<meta charset="utf-8">
	...
	<body style="background-color:#1E1F24;">
		...
		<div class="container">
			<h1 class="m-5"><u style="color:white;">Graphics Card</u></h1>
			<form action="" method="POST">
				<div class="row">
					<!--------------------------------ROW 1----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="0">
						<div class="card btn" style="width: 18rem;height:670px;">
						  <img src="<?php echo $row[0]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><?php echo $row[0]['title'];?><br><br></h5>
					...
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="1">
						<div class="card btn" style="width: 18rem;height:670px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="2">
						<div class="card btn" style="width: 18rem;height:670px;">
					...
					<!--------------------------------ROW 2----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="3">
						<div class="card btn" style="width: 18rem;height:750px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="4">
						<div class="card btn" style="width: 18rem;height:750px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="5">
						<div class="card btn" style="width: 18rem;height:750px;">
					...
					<!--------------------------------ROW 3----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="6">
						<div class="card btn" style="width: 18rem;height:622px;">
						  <img src="<?php echo $row[6]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><?php echo $row[6]['title'];?></h5>
							<p class="card-text"><?php echo $row[6]['description'];?><br></p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="7">
						<div class="card btn" style="width: 18rem;height:622px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="8">
						<div class="card btn" style="width: 18rem;height:622px;">
					...
					<!--------------------------------ROW 4----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="9">
						<div class="card btn" style="width: 18rem;height:676px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="10">
						<div class="card btn" style="width: 18rem;height:676px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="gc" type="submit" value="11">
						<div class="card btn" style="width: 18rem;height:676px;">
						  <img src="<?php echo $row[11]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><?php echo $row[11]['title'];?><br></h5>
