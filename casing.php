...
<html>
	<head>
		<title>Electro Built | Casing</title>
		<meta charset="utf-8">
	...
	<body style="background-color:#1E1F24;">
		...
		<div class="container">
			<h1 class="m-5"><u style="color:white;">Casing</u></h1>
			<form action="" method="POST">
			<div class="row">
				<!--------------------------------ROW 1----------------------------------------------------------- -->
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="0">
					<div class="card btn" style="width: 18rem;height:830px;">
					  <img src="<?php echo $row[0]['image'];?>" class="card-img-top" alt="...">
					  <div class="card-body">
						<h5 class="card-title"><?php echo $row[0]['title'];?></h5>
				...
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="1">
					<div class="card btn" style="width: 18rem;height:830px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="2">
					<div class="card btn" style="width: 18rem;height:830px;">
					  <img src="<?php echo $row[2]['image'];?>" class="card-img-top" alt="...">
					  <div class="card-body">
						<h5 class="card-title"><br><?php echo $row[2]['title'];?></h5>
						<p class="card-text"><br><?php echo $row[2]['description'];?></p>
					  </div>
					  <ul class="list-group list-group-flush">
				...
				<!--------------------------------ROW 2----------------------------------------------------------- -->
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="3">
					<div class="card btn" style="width: 18rem;height:804px;">
					  <img src="<?php echo $row[3]['image'];?>" class="card-img-top" alt="..." height="300">
					  <div class="card-body">
						<h5 class="card-title"><br><br><?php echo $row[3]['title'];?><br></h5>
				...
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="4">
					<div class="card btn" style="width: 18rem;height:804px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="5">
					<div class="card btn" style="width: 18rem;height:804px;">
					  <img src="<?php echo $row[5]['image'];?>" class="card-img-top" alt="...">
					  <div class="card-body">
						<h5 class="card-title"><br><?php echo $row[5]['title'];?></h5>
				...
				<!--------------------------------ROW 3----------------------------------------------------------- -->
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="6">
					<div class="card btn" style="width: 18rem;height:736px;">
					  <img src="<?php echo $row[6]['image'];?>" class="card-img-top" alt="...">
					  <div class="card-body">
						<h5 class="card-title"><?php echo $row[6]['title'];?></h5>
				...
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="7">
					<div class="card btn" style="width: 18rem;height:736px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="8">
					<div class="card btn" style="width: 18rem;height:736px;">
					  <img src="<?php echo $row[8]['image'];?>" class="card-img-top" alt="...">
					  <div class="card-body">
						<h5 class="card-title"><br><?php echo $row[8]['title'];?><br></h5>
				...
				<!--------------------------------ROW 4----------------------------------------------------------- -->
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="9">
					<div class="card btn" style="width: 18rem;height:789px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="10">
					<div class="card btn" style="width: 18rem;height:789px;">
					  <img src="<?php echo $row[10]['image'];?>" class="card-img-top" alt="...">
					  <div class="card-body">
						<h5 class="card-title"><br><?php echo $row[10]['title'];?></h5>
				...
				<div class="col-md-4 mb-3">
				<button  name="casing" type="submit" value="11">
					<div class="card btn" style="width: 18rem;height:789px;">
					  <img src="<?php echo $row[11]['image'];?>" class="card-img-top" alt="...">
					  <div class="card-body">
						<h5 class="card-title"><?php echo $row[11]['title'];?></h5>
