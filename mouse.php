...
<html>
	<head>
		<title>Electro Built | Mouse</title>
		<meta charset="utf-8">
	...
	<body style="background-color:#1E1F24;">
		...
		<div class="container">
			<h1 class="m-5"><u style="color:white;">Mouse</u></h1>
			<form action="" method="POST">
				<div class="row">
					<!--------------------------------ROW 1----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="0">
						<div class="card btn" style="width: 18rem;height:672px;">
						  <img src="<?php echo $row[0]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><?php echo $row[0]['title'];?></h5>
							<p class="card-text"><?php echo $row[0]['description'];?></p>
						  </div>
					...
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="1">
						<div class="card btn" style="width: 18rem;height:672px;">
						  <img src="<?php echo $row[1]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><?php echo $row[1]['title'];?><br><br></h5>
					...
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="2">
						<div class="card btn" style="width: 18rem;height:672px;">
					...
					<!--------------------------------ROW 2----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="3">
						<div class="card btn" style="width: 18rem;height:710px;">
						  <img src="<?php echo $row[3]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><?php echo $row[3]['title'];?><br><br></h5>
					...
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="4">
						<div class="card btn" style="width: 18rem;height:710px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="5">
						<div class="card btn" style="width: 18rem;height:710px;">
					...
					<!--------------------------------ROW 3----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="6">
						<div class="card btn" style="width: 18rem;height:672px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="7">
						<div class="card btn" style="width: 18rem;height:672px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="8">
						<div class="card btn" style="width: 18rem;height:672px;">
					...
					<!--------------------------------ROW 4----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="9">
						<div class="card btn" style="width: 18rem;height:838px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="10">
						<div class="card btn" style="width: 18rem;height:838px;">
					...
					<div class="col-md-4 mb-3">
						<button  name="m" type="submit" value="11">
						<div class="card btn" style="width: 18rem;height:838px;">
