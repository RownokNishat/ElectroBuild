			...
			<form action="" method="POST">
				<div class="row">
					...
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="0">
						<div class="card btn" style="width: 18rem;height:562px;">
						  <img src="<?php echo $row[0]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><?php echo $row[0]['title'];?></h5>
					...
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="1">
						<div class="card btn" style="width: 18rem;height:562px;">
					...
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="2">
						<div class="card btn" style="width: 18rem;height:562px;">
					...
					<!--------------------------------ROW 2----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="3">
						<div class="card btn" style="width: 18rem;height:529px;">
					...
					<!--------------------------------ROW 3----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="6">
						<div class="card btn" style="width: 18rem;">
						  <img src="<?php echo $row[6]['image'];?>" class="card-img-top" alt="..." height="200">
						  <div class="card-body">
					...
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="7">
						<div class="card btn" style="width: 18rem;height:552px;">
						  <img src="<?php echo $row[7]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><?php echo $row[7]['title'];?></h5>
							<p class="card-text"><?php echo $row[7]['description'];?>
							</p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="8">
						<div class="card btn" style="width: 18rem;height:552px;">
					...
					<!--------------------------------ROW 4----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="9">
						<div class="card btn" style="width: 18rem;height:563px;">
						  <img src="<?php echo $row[9]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><?php echo $row[9]['title'];?></h5>
							<p class="card-text"><br><br><?php echo $row[9]['description'];?></p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="10">
						<div class="card btn" style="width: 18rem;height:563px;">
					...
					<div class="col-md-4 mb-3">
						<button name="ssd" type="submit" value="11">
						<div class="card btn" style="width: 18rem;height:563px;">
