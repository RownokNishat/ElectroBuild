...
<html>
	...
	<body style="background-color:#1E1F24;">
		...
		<div class="container">
			<h1 class="m-5"><u style="color:white;">RAM</u></h1>
			<form action="" method="POST">
				<div class="row">
					<!--------------------------------ROW 1----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="0">
						<div class="card btn" style="width: 18rem;height:624px;">
						  <img src="<?php echo $row[0]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><br><?php echo $row[0]['title'];?><br><br></h5>
							<p class="card-text"><br><br><?php echo $row[0]['description'];?><br></p>
						  </div>
					...
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="1">
						<div class="card btn" style="width: 18rem;height:624px;">
						  <img src="<?php echo $row[1]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><?php echo $row[1]['title'];?></h5>
							<p class="card-text"><?php echo $row[1]['description'];?>
							</p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="2">
						<div class="card btn" style="width: 18rem;height:624px;">
					...
					<!--------------------------------ROW 2----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="3">
						<div class="card btn" style="width: 18rem;height:564px;">
						  <img src="<?php echo $row[3]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><br><br><?php echo $row[3]['title'];?></h5>
							<p class="card-text"><br><br><?php echo $row[3]['description'];?></p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="4">
						<div class="card btn" style="width: 18rem;height:564px;">
						  <img src="<?php echo $row[4]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><?php echo $row[4]['title'];?></h5>
							<p class="card-text"><?php echo $row[4]['description'];?>
							</p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="5">
						<div class="card btn" style="width: 18rem;height:564px;">
						  <img src="<?php echo $row[5]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><br><?php echo $row[5]['title'];?></h5>
					...
					<!--------------------------------ROW 3----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="6">
						<div class="card btn" style="width: 18rem;height:619px;">
						  <img src="<?php echo $row[6]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><br><br><?php echo $row[6]['title'];?></h5>
							<p class="card-text"><br><br><?php echo $row[6]['description'];?></p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="7">
						<div class="card btn" style="width: 18rem;height:619px;">
						  <img src="<?php echo $row[7]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><?php echo $row[7]['title'];?></h5>
							<p class="card-text"><?php echo $row[7]['description'];?></p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="8">
						<div class="card btn" style="width: 18rem;height:619px;">
						  <img src="<?php echo $row[8]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><br><?php echo $row[8]['title'];?></h5>
							<p class="card-text"><br><?php echo $row[8]['description'];?>
							</p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<!--------------------------------ROW 4----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="9">
						<div class="card btn" style="width: 18rem;height:516px;">
						  <img src="<?php echo $row[9]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><?php echo $row[9]['title'];?></h5>
					...
					<div class="col-md-4 mb-3">
						<button name="ram" type="submit" value="11">
						<div class="card btn" style="width: 18rem;height:516px;">
						  <img src="<?php echo $row[11]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><br><?php echo $row[11]['title'];?></h5>
							<p class="card-text"><br><?php echo $row[11]['description'];?>
							</p>
						  </div>
						  <ul class="list-group list-group-flush">
