...
<html>
	<head>
		<title>Electro Built | Monitor</title>
		<meta charset="utf-8">
	...
	<body style="background-color:#1E1F24;">
		...
		<div class="container">
			<h1 class="m-5"><u style="color:white;">MONITOR</u></h1>
				<form action="" method="POST">
			<div class="row">
				<!--------------------------------ROW 1----------------------------------------------------------- -->
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="0">
					<div class="card btn" style="width: 18rem;height:696px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="1">
					<div class="card btn" style="width: 18rem;height:696px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="2">
					<div class="card btn" style="width: 18rem;height:696px;">
				...
				<!--------------------------------ROW 2----------------------------------------------------------- -->
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="3">
					<div class="card btn" style="width: 18rem;height:706px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="4">
					<div class="card btn" style="width: 18rem;height:706px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="5">
					<div class="card btn" style="width: 18rem;height:706px;">
					  <img src="<?php echo $row[5]['image'];?>" class="card-img-top" alt="...">
					  <div class="card-body">
						<h5 class="card-title"><?php echo $row[5]['title'];?><br></h5>
				...
				<!--------------------------------ROW 3----------------------------------------------------------- -->
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="6">
					<div class="card btn" style="width: 18rem;height:643px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="7">
					<div class="card btn" style="width: 18rem;height:643px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="8">
					<div class="card btn" style="width: 18rem;height:643px;">
				...
				<!--------------------------------ROW 4----------------------------------------------------------- -->
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="9">
					<div class="card btn" style="width: 18rem;height:666px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="10">
					<div class="card btn" style="width: 18rem;height:666px;">
				...
				<div class="col-md-4 mb-3">
				<button  name="monitor" type="submit" value="11">
					<div class="card btn" style="width: 18rem;height:666px;">
