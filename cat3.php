...
<html>
	...
	<body style="background-color:#1E1F24;">
		...
		<div class="container">
			<h1 class="m-5"><u style="color:white;">Rams</u></h1>
					...
					<div class="col-md-4 mb-3">
						...
						<div class="card textcenter" style="width: 18rem;height:500px;"  data-bs-toggle="tooltip" data-bs-placement="bottom" title="<?php echo $row[$i]['description'];?>">
						  ...
						  <ul class="list-group list-group-flush">
							...
							<li class="list-group-item"><button name="ram" type="submit" value="<?php echo $i;?>" style="background-color:black;color:white;">Add to Cart</button></li>
						  </ul>
						</div>
					</div>
					<?php } ?>
