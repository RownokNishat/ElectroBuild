<?php
	...
	{
		$id=$_POST['motherboard'];
		$_SESSION['motherboard']=$row[$id];
...
<html>
	<head>
		<title>Electro Built | Motherboard</title>
		<meta charset="utf-8">
	...
	<body style="background-color:#1E1F24;">
		...
		<div class="container">
			<h1 class="m-5"><u style="color:white;">Motherboard</u></h1>
			<form action="" method="POST">
				<div class="row">
					<!--------------------------------ROW 1----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="0">
						<div class="card btn" style="width: 18rem;height:659px;">
					...
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="1">
						<div class="card btn" style="width: 18rem;height:659px;">
					...
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="2">
						<div  class="card btn" style="width: 18rem;height:659px;">
					...
					<!--------------------------------ROW 2----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="3">
						<div class="card btn" style="width: 18rem;height:854px;">
					...
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="4">
						<div class="card btn" style="width: 18rem;height:854px;">
						  <img src="<?php echo $row[4]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><?php echo $row[4]['title'];?><br></h5>
					...
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="5">
						<div class="card btn" style="width: 18rem;height:854px;">
					...
					<!--------------------------------ROW 3----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="6">
						<div class="card btn" style="width: 18rem;height:690px;">
						  <img src="<?php echo $row[6]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><br><?php echo $row[6]['title'];?><br></h5>
					...
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="7">
						<div class="card btn" style="width: 18rem;height:690px;">
						  <img src="<?php echo $row[7]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><br><br><?php echo $row[7]['title'];?></h5>
							<p class="card-text"><br><br><br><?php echo $row[7]['description'];?></p>
						  </div>
						  <ul class="list-group list-group-flush">
					...
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="8">
						<div class="card btn" style="width: 18rem;height:690px;">
						  <img src="<?php echo $row[8]['image'];?>" class="card-img-top" alt="...">
						  <div class="card-body">
							<h5 class="card-title"><?php echo $row[8]['title'];?><br></h5>
					...
					<!--------------------------------ROW 4----------------------------------------------------------- -->
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="9">
						<div class="card btn" style="width: 18rem;height:658px;">
					...
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="10">
						<div class="card btn" style="width: 18rem;height:658px;">
					...
					<div class="col-md-4 mb-3">
						<button name="motherboard" type="submit" value="11">
						<div class="card btn" style="width: 18rem;height:658px;">
